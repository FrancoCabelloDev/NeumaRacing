...
<body>
        ...
        <div class="flex items-center space-x-14">
            ...
            <div class="flex items-center space-x-2">
                <a href="/" class="flex items-center space-x-2">
                    ...
                    <span>jcnllantas@gmail.com</span>
                </a>
            </div>
            <!-- WhatsApp -->
    ...
    <nav class="bg-black text-white flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center space-x-4">
            <a href="/">
                <img src="{{ asset('img/LogoNeumaRacing.png') }}" alt="Neuma Racing" class="h-11">
            </a>
        </div> 
        ...
        <div class="flex justify-center flex-1">
            <div class="relative w-96">
                <!-- Imagen de Lupa -->
                <img src="{{ asset('img/lupa.png') }}" alt="Buscar" class="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5"/>
                <!-- Campo de Entrada -->
                <input 
                    type="text" 
                    placeholder="Buscar" 
                    class="w-full pl-12 pr-4 py-2 rounded-full bg-custom-gray text-white placeholder-gray-400 focus:outline none hover:bg-white hover:bg-opacity-20 transition-colors duration-200"/>
            </div>
        </div>
